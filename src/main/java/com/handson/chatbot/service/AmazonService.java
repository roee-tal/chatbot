...
public class AmazonService {
    ...
    public static final Pattern PRODUCT_PATTERN = Pattern.compile("<span class=\\\"a-size-medium a-color-base a-text-normal\\\">([^<]+)<\\/span>.*<span class=\\\"a-icon-alt\\\">([^<]+).*<span class=\\\"a-offscreen\\\">([^<]+)<\\/span>");
    ...
    private String getProductHtml(String keyword) throws IOException {
        ...
        Request request = new Request.Builder()
                .url("https://www.amazon.com/s?crid=2KM1XFV0G8AA9&i=aps&k=" + keyword + "&ref=nb_sb_noss_2&sprefix=ipod%2Caps%2C84&url=search-alias%3Daps")
                .method("GET", null)
